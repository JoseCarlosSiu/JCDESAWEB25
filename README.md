...
- Catálogo con filtros simulados
...
1. **Fase 1:** Diseño de wireframes y planificación.
2. **Fase 2:** Maquetación HTML y CSS.
3. **Fase 3:** Implementación de JavaScript para el carrito.
4. **Fase 4:** Desarrollo del módulo de servicio técnico.
5. **Fase 5:** Integración y pruebas.
6. **Fase 6:** Documentación y presentación.

## Tabla de roles de usuario

| Rol | Permisos |
|------|-----------|
| Cliente | Ver productos, añadir al carrito, solicitar servicio |
| Administrador | Gestionar productos, ver solicitudes de servicio |
| Técnico | Revisar solicitudes de servicio, actualizar estados |
...
[![Imagen primero que visto](https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png)](https://github.com)
...
[Ver detalle funcional del proyecto](./detalle-funcional.md)
